					...
					<div class="box">
						...
						<ul class="list-group no-border m-b">
					        <li class="list-group-item">
					          <a href="#" class="pull-left w-40 m-r"><img src="/element/images/a8.jpg" class="img-responsive img-circle" alt="."></a>
					          <div class="clear">
					        ...
					        <li class="list-group-item">
					          <a href="" class="pull-left w-40 m-r"><img src="/element/images/a2.jpg" class="img-responsive img-circle" alt="."></a>
					          <div class="clear">
					        ...
					        <li class="list-group-item">
					          <a href="" class="pull-left w-40 m-r"><img src="/element/images/a3.jpg" class="img-responsive img-circle" alt="."></a>
					          <div class="clear">
					        ...
					        <li class="list-group-item">
					          <a href="" class="pull-left w-40 m-r"><img src="/element/images/a4.jpg" class="img-responsive img-circle" alt="."></a>
					          <div class="clear">
			...
			<div class="list inset">
				<a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		                	...
		                	<img src="/element/images/a1.jpg" class="w-20" alt=".">
		                </span>
		            </span>
	            ...
	            <a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		            		<i class="on avatar-center no-border"></i>
		                	<img src="/element/images/a2.jpg" class="w-20" alt=".">
		                </span>
		            </span>
		            <span class="list-body text-ellipsis">
		            	Crystal Guerrero
	            ...
	            <a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		            		<i class="on avatar-center no-border"></i>
		                	<img src="/element/images/a3.jpg" class="w-20" alt=".">
		                </span>
		            </span>
		            <span class="list-body text-ellipsis">
		            	Judith Garcia
	            ...
	            <a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		                	...
		                	<img src="/element/images/a4.jpg" class="w-20" alt=".">
		                </span>
		            </span>
		            <span class="list-body text-ellipsis">
		            	Melissa Garza
	            ...
	            <a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		                	...
		                	<img src="/element/images/a5.jpg" class="w-20" alt=".">
		                </span>
		            </span>
		            <span class="list-body text-ellipsis">
		            	Douglas Torres
  	    ...
  	    <div class="row-row light">
  	      <div class="row-body scrollable hover">
  	        <div class="row-inner">
  	          <div class="p-a-md">
  	            <div class="m-b">
  	              <a href="#" class="pull-left w-40 m-r-sm"><img src="/element/images/a2.jpg" alt="..." class="w-full img-circle"></a>
  	              <div class="clear">
  	            ...
  	            <div class="m-b">
  	              <a href="#" class="pull-right w-40 m-l-sm"><img src="/element/images/a3.jpg" class="w-full img-circle" alt="..."></a>
