...
<head>
  ...
  <link rel="apple-touch-icon" href="/element/images/logo.png">
  <meta name="apple-mobile-web-app-title" content="Flatkit">
  <!-- for Chrome on Android, multi-resolution icon of 196x196 -->
  <meta name="mobile-web-app-capable" content="yes">
  <link rel="shortcut icon" sizes="196x196" href="/element/images/logo.png">
  
  <!-- style -->
  <link rel="stylesheet" href="/element/css/animate.css/animate.min.css" type="text/css" />
  <link rel="stylesheet" href="/element/css/glyphicons/glyphicons.css" type="text/css" />
  <link rel="stylesheet" href="/element/css/font-awesome/css/font-awesome.min.css" type="text/css" />
  <link rel="stylesheet" href="/element/css/material-design-icons/material-design-icons.css" type="text/css" />
  <link rel="stylesheet" href="/element/css/ionicons/css/ionicons.min.css" type="text/css" />
  <link rel="stylesheet" href="/element/css/simple-line-icons/css/simple-line-icons.css" type="text/css" />
  <link rel="stylesheet" href="/element/css/bootstrap/dist/css/bootstrap.min.css" type="text/css" />

  <!-- build:css css/styles/app.min.css -->
  <link rel="stylesheet" href="/element/css/styles/app.css" type="text/css" />
  <link rel="stylesheet" href="/element/css/styles/style.css" type="text/css" />
  <!-- endbuild -->
  <link rel="stylesheet" href="/element/css/styles/font.css" type="text/css" />
</head>
    ...
    <div class="navside dk" data-layout="column">
      <div class="navbar no-radius">
        ...
        <a href="index.html" class="navbar-brand">
        	...
        	<img src="/element/images/logo.png" alt="." class="hide">
        ...
        <div class="nav-fold dropup">
          <a data-toggle="dropdown">
              <div class="pull-left">
                ...
                <img src="/element/images/a0.jpg" alt="..." class="w-40 img-circle hide">
              </div>
                          ...
                          <ul class="list-group list-group-gap m-a-0">
                            <li class="list-group-item dark-white box-shadow-z0 b">
                              <span class="pull-left m-r">
                                <img src="/element/images/a0.jpg" alt="..." class="w-40 img-circle">
                              </span>
                            ...
                            <li class="list-group-item dark-white box-shadow-z0 b">
                              <span class="pull-left m-r">
                                <img src="/element/images/a1.jpg" alt="..." class="w-40 img-circle">
                              </span>
                              <span class="clear block">
                            ...
                            <li class="list-group-item dark-white text-color box-shadow-z0 b">
                              <span class="pull-left m-r">
                                <img src="/element/images/a2.jpg" alt="..." class="w-40 img-circle">
                              </span>
                              <span class="clear block">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link clear" data-toggle="dropdown">
                      <span class="avatar w-32">
                        <img src="/element/images/a3.jpg" class="w-full rounded" alt="...">
                      </span>
                    </a>
...
<!-- jQuery -->
  <script src="/element/libs/jquery/dist/jquery.js"></script>
<!-- Bootstrap -->
  <script src="/element/libs/tether/dist/js/tether.min.js"></script>
  <script src="/element/libs/bootstrap/dist/js/bootstrap.js"></script>
<!-- core -->
  <script src="/element/libs/jQuery-Storage-API/jquery.storageapi.min.js"></script>
  <script src="/element/libs/PACE/pace.min.js"></script>
  <script src="/element/libs/jquery-pjax/jquery.pjax.js"></script>
  <script src="/element/libs/blockUI/jquery.blockUI.js"></script>
  <script src="/element/libs/jscroll/jquery.jscroll.min.js"></script>

  <script src="/element/scripts/config.lazyload.js"></script>
  <script src="/element/scripts/ui-load.js"></script>
  <script src="/element/scripts/ui-jp.js"></script>
  <script src="/element/scripts/ui-include.js"></script>
  <script src="/element/scripts/ui-device.js"></script>
  <script src="/element/scripts/ui-form.js"></script>
  <script src="/element/scripts/ui-modal.js"></script>
  <script src="/element/scripts/ui-nav.js"></script>
  <script src="/element/scripts/ui-list.js"></script>
  <script src="/element/scripts/ui-screenfull.js"></script>
  <script src="/element/scripts/ui-scroll-to.js"></script>
  <script src="/element/scripts/ui-toggle-class.js"></script>
  <script src="/element/scripts/ui-taburl.js"></script>
  <script src="/element/scripts/app.js"></script>
  <script src="/element/scripts/ajax.js"></script>
<!-- endbuild -->
</body>
</html>
